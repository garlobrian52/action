...
- branch - Branch the action treats as the release base (version PR targets this branch; version branch is `changeset-release/<branch>`). Defaults to the current ref name (`github.ref_name` / `github.context.ref`).
